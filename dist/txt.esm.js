...
function () {
  function Path(path) {
    ...
    var fit = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : PathFit.Rainbow;
    var align = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : PathAlign.Center;
    ...
    _defineProperty(this, "fit", PathFit.Rainbow);

    _defineProperty(this, "align", PathAlign.Center);
...
function (_createjs$Container) {
  ...
  function PathText() {
    ...
    _defineProperty(_assertThisInitialized(_this), "fit", PathFit.Rainbow);

    _defineProperty(_assertThisInitialized(_this), "align", PathAlign.Center);
  ...
  _createClass(PathText, [{
    ...
    value: function setFit() {
      var fit = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : PathFit.Rainbow;
      this.fit = fit;
    ...
    value: function setAlign() {
      var align = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : PathAlign.Center;
      this.align = align;
